...
public class EntityEColiChickenMob extends EntityMob{
	...
	//When an EColiChicken kills a Chicken, this is activated.
		public void onKillEntity(EntityLivingBase p_70074_1_)
	    {
	        super.onKillEntity(p_70074_1_);

	        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && p_70074_1_ instanceof EntityChicken)
	        {
	            ...
	            EntityEColiChickenMob entityEColiChicken = new EntityEColiChickenMob(this.worldObj);
	            entityEColiChicken.copyLocationAndAnglesFrom(p_70074_1_);
	            this.worldObj.removeEntity(p_70074_1_);
	            entityEColiChicken.onSpawnWithEgg((IEntityLivingData)null);
	            entityEColiChicken.setChicken(true);

	            this.worldObj.spawnEntityInWorld(entityEColiChicken);
	        }
	    }
	...
	public boolean attackEntityAsMob(Entity p_70652_1_)
    {
        if (super.attackEntityAsMob(p_70652_1_))
        {
            if (p_70652_1_ instanceof EntityLivingBase)
            {
                ...
                if (((EntityLivingBase)p_70652_1_).isPotionActive(EpidemicCraft.potionEColiVaccine))
                {	
                	return false;
                }
