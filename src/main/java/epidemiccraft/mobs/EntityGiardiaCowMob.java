...
public class EntityGiardiaCowMob extends EntityMob{


	private int conversionTime;

	//What are his priorities?
	public EntityGiardiaCowMob(World par1World) {
		super(par1World);
	...
	protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            ...
            {
                this.dropItem(ModItems.TissueGiardia, 1);
            }
        }
    }
	...
	//When an GiardiaCow kills a Cow, this is activated.
	public void onKillEntity(EntityLivingBase p_70074_1_)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && p_70074_1_ instanceof EntityCow)
        {
            ...
            EntityGiardiaCowMob entityGiardiaCow = new EntityGiardiaCowMob(this.worldObj);
            entityGiardiaCow.copyLocationAndAnglesFrom(p_70074_1_);
            this.worldObj.removeEntity(p_70074_1_);
            entityGiardiaCow.onSpawnWithEgg((IEntityLivingData)null);
            entityGiardiaCow.setCow(true);

            this.worldObj.spawnEntityInWorld(entityGiardiaCow);
        }
    }
	
	//When you get attacked by the GiardiaCow, this is activated.
        ...
        if (super.attackEntityAsMob(p_70652_1_))
        {
            if (p_70652_1_ instanceof EntityLivingBase)
            {
                ...
                if (b0 > 0)
                {
                	...
                	if (((EntityLivingBase)p_70652_1_).isPotionActive(EpidemicCraft.potionGiardiaVaccine))
                    {	
                    	return false;
                    }
                    ...
                    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(EpidemicCraft.potionGiardia.id, b0 * 1200, 0));
	...
	//Start converting the GiardiaCow into a normal Cow.
	...
	public boolean interact(EntityPlayer p_70085_1_)
    {
        ...
        if (itemstack != null && itemstack.getItem() == ModItems.SyringeGiardia && itemstack.getItemDamage() == 0)
        {
	...
	//What happens to the Cow's AI when the GiardiaCow finishes converting?
	protected void convertToCow()
    {
        EntityCow entitycow = new EntityCow(this.worldObj);
        entitycow.copyLocationAndAnglesFrom(this);
        entitycow.onSpawnWithEgg((IEntityLivingData)null);

        this.worldObj.removeEntity(this);
        this.worldObj.spawnEntityInWorld(entitycow);
        entitycow.addPotionEffect(new PotionEffect(Potion.confusion.id, 200, 0));
    }
