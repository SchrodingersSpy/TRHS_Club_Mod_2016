...
public class EntityPolioVillagerMob extends EntityMob{


	private int conversionTime;

	//What are his priorities?
	public EntityPolioVillagerMob(World par1World) {
		super(par1World);
	...
	protected void dropFewItems(boolean p_70628_1_, int p_70628_2_)
    {
        ...
        for (k = 0; k < j; ++k)
        {
            ...
            {
                this.dropItem(ModItems.TissuePolio, 1);
            }
        }
    }
	...
	//When an PolioVillager kills a Villager, this is activated.
	public void onKillEntity(EntityLivingBase p_70074_1_)
    {
        ...
        if ((this.worldObj.difficultySetting == EnumDifficulty.NORMAL || this.worldObj.difficultySetting == EnumDifficulty.HARD) && p_70074_1_ instanceof EntityVillager)
        {
            ...
            EntityPolioVillagerMob entityPolioVillager = new EntityPolioVillagerMob(this.worldObj);
            entityPolioVillager.copyLocationAndAnglesFrom(p_70074_1_);
            this.worldObj.removeEntity(p_70074_1_);
            entityPolioVillager.onSpawnWithEgg((IEntityLivingData)null);
            entityPolioVillager.setVillager(true);

            this.worldObj.spawnEntityInWorld(entityPolioVillager);
        }
    }
	
	//When you get attacked by the PolioVillager, this is activated.
	public boolean attackEntityAsMob(Entity p_70652_1_)
    {
        if (super.attackEntityAsMob(p_70652_1_))
        {
            if (p_70652_1_ instanceof EntityLivingBase)
            {
                ...
                if (((EntityLivingBase)p_70652_1_).isPotionActive(EpidemicCraft.potionPolioVaccine))
                {	
                	return false;
                }
                ...
                else
                {
                    ...
                    ((EntityLivingBase)p_70652_1_).addPotionEffect(new PotionEffect(EpidemicCraft.potionPolio.id, b0 * 1200, 0));
	...
	//Start converting the PolioVillager into a normal Villager.
    ...
    //What happens when you stick the Villager with a Syringe?
	...
	//What happens when you right click the Villager with a syringe?
	public boolean interact(EntityPlayer p_70085_1_)
    {
        ItemStack itemstack = p_70085_1_.getCurrentEquippedItem();

        if (itemstack != null && itemstack.getItem() == ModItems.SyringePolio && itemstack.getItemDamage() == 0)
        {
	...
	//What happens to the Villager's AI when the PolioVillager finishes converting?
	...
	//If we run this, the PolioVillager turns into a Villager.
	...
	//What does the Villager say while idling?
	protected String getLivingSound()
    {
        return "mob.villager.hurt";
    }

	//What does the Villager say while in pain?
	protected String getHurtSound()
    {
        return "mob.villager.hurt";
    }
	
	//What does the Villager say when he dies?
