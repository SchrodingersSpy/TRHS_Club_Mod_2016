...
import epidemiccraft.blocks.Incubator;
import epidemiccraft.com.IncubatorRecipes;
...
public class TileEntityIncubator extends TileEntity implements ISidedInventory{
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.furnaceName : "Incubator";
    }
     ...
     public void updateEntity()
        {
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                {
                    flag1 = true;
                    Incubator.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
                }
            }
