...
public class SyringeMeningitis extends ItemFood {

private String name = "SyringeMeningitis";
	
	public SyringeMeningitis(int heal, float saturation, boolean wolfMeat){
		...
		setPotionEffect(EpidemicCraft.potionMeningitisVaccine.id, 900, 0, 1.0F);
		this.maxStackSize = 1;
	}
