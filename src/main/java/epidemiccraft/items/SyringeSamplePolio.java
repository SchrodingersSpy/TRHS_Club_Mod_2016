...
public class SyringeSamplePolio extends ItemFood {

private String name = "SyringeSamplePolio";
	
	public SyringeSamplePolio(int heal, float saturation, boolean wolfMeat){
