...
public class SyringeCPox extends ItemFood {

private String name = "SyringeCPox";
	
	public SyringeCPox(int heal, float saturation, boolean wolfMeat){
		...
		setPotionEffect(EpidemicCraft.potionCPoxVaccine.id, 900, 0, 1.0F);
		this.maxStackSize = 1;
	}
