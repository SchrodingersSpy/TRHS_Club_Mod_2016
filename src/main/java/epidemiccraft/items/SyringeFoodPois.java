...
public class SyringeFoodPois extends ItemFood {

private String name = "SyringeFoodPois";
	
	public SyringeFoodPois(int heal, float saturation, boolean wolfMeat){
		...
		setPotionEffect(EpidemicCraft.potionFoodPoisVaccine.id, 900, 0, 1.0F);
		this.maxStackSize = 1;
	}
