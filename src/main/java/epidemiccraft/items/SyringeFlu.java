...
public class SyringeFlu extends ItemFood {

private String name = "SyringeFlu";
	
	public SyringeFlu(int heal, float saturation, boolean wolfMeat){
		...
		setPotionEffect(EpidemicCraft.potionFluVaccine.id, 900, 0, 1.0F);
		this.maxStackSize = 1;
	}
