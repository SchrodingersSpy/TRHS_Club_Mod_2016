...
public class SyringePolio extends ItemFood {

private String name = "SyringePolio";
	
	public SyringePolio(int heal, float saturation, boolean wolfMeat){
		...
		setPotionEffect(EpidemicCraft.potionPolioVaccine.id, 900, 0, 1.0F);
		this.maxStackSize = 1;
	}
