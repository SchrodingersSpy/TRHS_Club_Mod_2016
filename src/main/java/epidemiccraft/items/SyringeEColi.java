...
public class SyringeEColi extends ItemFood {

private String name = "SyringeEColi";
	
	public SyringeEColi(int heal, float saturation, boolean wolfMeat){
		...
		setPotionEffect(EpidemicCraft.potionEColiVaccine.id, 900, 0, 1.0F);
		this.maxStackSize = 1;
	}
