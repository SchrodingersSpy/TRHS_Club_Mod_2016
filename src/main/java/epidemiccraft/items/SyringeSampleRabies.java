...
public class SyringeSampleRabies extends ItemFood {

private String name = "SyringeSampleRabies";
	
	public SyringeSampleRabies(int heal, float saturation, boolean wolfMeat){
