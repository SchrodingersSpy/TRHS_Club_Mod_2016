...
public class SpinalTapSyringeFull extends ItemFood {

private String name = "SpinalTapSyringeFull";
	
	public SpinalTapSyringeFull(int heal, float saturation, boolean wolfMeat){
