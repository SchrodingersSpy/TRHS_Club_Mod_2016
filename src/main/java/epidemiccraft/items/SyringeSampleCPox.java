...
public class SyringeSampleCPox extends ItemFood {

private String name = "SyringeSampleEColi";
	
	public SyringeSampleCPox(int heal, float saturation, boolean wolfMeat){
