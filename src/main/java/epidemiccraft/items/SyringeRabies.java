...
public class SyringeRabies extends ItemFood {

private String name = "SyringeRabies";
	
	public SyringeRabies(int heal, float saturation, boolean wolfMeat){
		...
		setPotionEffect(EpidemicCraft.potionRabiesVaccine.id, 900, 0, 1.0F);
		this.maxStackSize = 1;
	}
