...
public class EventMilk {
		...
		public void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
			...
			ChatComponentText joinText = new ChatComponentText("Welcome to EpidemicCraft, " + event.player.getDisplayName() + "! If you downloaded this mod from anywhere other than Minecraft Forums, you may be at risk for a virus since I don't use any other download websites!");									
			joinText.getChatStyle().setItalic(true).setColor(EnumChatFormatting.GOLD);
			event.player.addChatComponentMessage(joinText);
