...
public class EventPotionZero {
	...
	@SubscribeEvent
	public void removemoveSpeed(LivingUpdateEvent event) {
	...
	@SubscribeEvent
	public void removeinvisibility(LivingUpdateEvent event) {
		if (event.entityLiving.isPotionActive(Potion.invisibility)) {
	...
	@SubscribeEvent
	public void removeblindness(LivingUpdateEvent event) {
		if (event.entityLiving.isPotionActive(Potion.blindness)) {
			if (event.entityLiving.getActivePotionEffect(Potion.blindness).getDuration()==0) {
	...
	@SubscribeEvent
	public void removenightVision(LivingUpdateEvent event) {
	...
	@SubscribeEvent
	public void removehunger(LivingUpdateEvent event) {
		if (event.entityLiving.isPotionActive(Potion.hunger)) {
			if (event.entityLiving.getActivePotionEffect(Potion.hunger).getDuration()==0) {
	...
	@SubscribeEvent
	public void removeweakness(LivingUpdateEvent event) {
		if (event.entityLiving.isPotionActive(Potion.weakness)) {
			if (event.entityLiving.getActivePotionEffect(Potion.weakness).getDuration()==0) {
	...
	@SubscribeEvent
	public void removepoison(LivingUpdateEvent event) {
		if (event.entityLiving.isPotionActive(Potion.poison)) {
			if (event.entityLiving.getActivePotionEffect(Potion.poison).getDuration()==0) {
	...
	@SubscribeEvent
	public void removewither(LivingUpdateEvent event) {
		if (event.entityLiving.isPotionActive(Potion.wither)) {
			if (event.entityLiving.getActivePotionEffect(Potion.wither).getDuration()==0) {
